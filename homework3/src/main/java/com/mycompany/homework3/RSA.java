 ...
 * @version 1.0
 * Review https://www.alvarodeleon.net/encriptar-y-desencriptar-con-rsa-en-java/
...
public class RSA {
    ...
    /**
     * Method to get the public key path with the name of the file with an name
     * alteration to be stored
     *
    ...
    /**
     * Method to get the encrypted file path with an name alteration to be
     * stored
     *
