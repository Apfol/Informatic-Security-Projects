...
/**
 * Class RSA works as a place where the RSA Algotithm can store all the information needed.
 *
 * @author Andres Ramos
 * @author Carlos Gutierrez
 * @version 1.0 Review https://www.alvarodeleon.net/encriptar-y-desencriptar-con-rsa-en-java/
...
public class RSA {
  ...
  static final String PRIVATE_KEY_NAME = "private.pem";
  ...
  /**
   * Method to get the public key path with the name of the file with an name alteration to be
   * stored
   *
   ...
   *
   * @param fileToEncrypt A file that contains some kind of information and will be encrypted.
   *     Extensions pretty like txt or cvs
   */
   ...
   * @throws InvalidKeySpecException Throws an exception when there is an invalid encoding key
   */
  public void setPrivateKeyString(String key)
  ...
  /**
   * Method to encrypt the file previously settled. Transform the file into a byte array, then it is
   * encoded into a Base64 standard, finally drops it into the file encrypted path. "encrypt"
   * directory.
   *
   * @throws NoSuchAlgorithmException Throws an exception when an Cryptographic algorithm is
   *     requested but is not available.
   ...
   *     to a block cipher is incorrect
   * @throws BadPaddingException Throws an exception when the provided data is not padding properly
   * @throws InvalidKeySpecException Throws an exception when there is an different spec of the key
   *     provided
   * @throws UnsupportedEncodingException Throws an exception when the file encoding is different
   *     form expected
   * @throws NoSuchProviderException Throws an exception when the security provider is requested but
   *     is not available
   */
  public void encrypt()
      throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException,
          IllegalBlockSizeException, BadPaddingException, InvalidKeySpecException,
          UnsupportedEncodingException, NoSuchProviderException, IOException {
    byte[] encryptedBytes;
