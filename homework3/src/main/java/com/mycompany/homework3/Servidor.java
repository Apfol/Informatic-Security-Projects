...
/**
 * Class Servidor works as an socket server with capacity to manage socket
 * threads
 *
 * @author Andres Ramos
...
public class Servidor {
    ...
    /**
     * Method where the socket is created with the port 5056 and local ip host,
     * then wait for connections and send them to a class extended from socket
     * threads
     *
     * @param publicpath String with the public file path to be sent
     * @param pathtosave String with the path where the encrypted file would be
     * stored
     * @see FileShare
     *
